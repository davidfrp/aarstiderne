package com.davidfrp.aarstiderne.util;
...
public class SnowflakeGenerator implements IdentifierGenerator {
    ...
    private static final long AARSTIDERNE_EPOCH = 1609455600000L; // 01-01-2021 00:00:00
    ...
    public Serializable generate(SharedSessionContractImplementor sharedSessionContractImplementor, Object object) {
        ...
        String snowflakeTimestamp = Long.toBinaryString(System.currentTimeMillis() - AARSTIDERNE_EPOCH);
